...
/*      用java打开本地exe文件
        ...
        processBuilder.command("D:\\Typora\\Typora.exe");
        processBuilder.redirectErrorStream(true);
        Process start = processBuilder.start();*/
        //ffmpeg的路径
        String ffmpeg_path = "D:\\BaiduNetDiskDownload\\黑马\\学成在线项目—资料\\day01 项目介绍&环境搭建\\资料\\常用软件工具\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "C:\\Users\\SheYue\\Videos\\2023-04-06 13-30-11.mp4";
        //转换后mp4文件的名称
        String mp4_name = "test01.avi";
        //转换后mp4文件的路径
        String mp4_path = "C:\\Users\\SheYue\\Videos\\test01.avi";
        //创建工具类对象
